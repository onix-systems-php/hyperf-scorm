...
(function() {
    ...
    var sessionData = window.scormSessionData || {};
    var apiEndpoint = config.apiEndpoint || '/api/v1/scorm/api';
    var attemptId = sessionData.attemptId || null;
    var debug = config.debug || false;
    
    // SCORM data storage - initialize from session
    var data = {
        "cmi.core.student_id": sessionData.userId || "",
        "cmi.core.student_name": sessionData.userName || "",
        "cmi.core.lesson_location": sessionData.currentLocation || "",
        "cmi.core.credit": "credit",
        "cmi.core.lesson_status": sessionData.status || "not attempted",
        "cmi.core.entry": "",
        "cmi.core.score.raw": sessionData.score || "",
        "cmi.core.score.max": "",
        "cmi.core.score.min": "",
        ...
        "cmi.suspend_data": sessionData.suspendData || "",
        "cmi.launch_data": "",
        "cmi.comments": "",
    ...
    function saveDataToServer() {
        ...
        return fetch(apiEndpoint + '/' + attemptId + '/commit', {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                action: 'commit',
                data: Object.assign({}, data, interactions, objectives, pendingData),
                parameter: ''
            })
    ...
    function loadDataFromServer() {
        ...
        try {
            // This could be implemented to load existing session data
    ...
    window.API = {
        LMSInitialize: function(parameter) {
            ...
            if (attemptId) {
                fetch(apiEndpoint + '/' + attemptId + '/initialize', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-Requested-With': 'XMLHttpRequest'
        ...
        LMSFinish: function(parameter) {
            ...
            if (attemptId) {
                fetch(apiEndpoint + '/' + attemptId + '/terminate', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-Requested-With': 'XMLHttpRequest'
